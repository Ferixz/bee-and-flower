...
class SolutionsControllerTest < ActionController::TestCase
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post :create, solution: { game_id: @solution.game_id, level_id: @solution.level_id, result: @solution.result, user_id: @solution.user_id }
    end
  ...
  test "should update solution" do
    patch :update, id: @solution, solution: { game_id: @solution.game_id, level_id: @solution.level_id, result: @solution.result, user_id: @solution.user_id }
    assert_redirected_to solution_path(assigns(:solution))
  end
