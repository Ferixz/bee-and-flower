...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { links_list: @level.links_list, nodes_list: @level.nodes_list, number_of_nodes: @level.number_of_nodes }
    end
  ...
  test "should update level" do
    patch :update, id: @level, level: { links_list: @level.links_list, nodes_list: @level.nodes_list, number_of_nodes: @level.number_of_nodes }
    assert_redirected_to level_path(assigns(:level))
  end
